...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/mask_data_format.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp180/weights/best.pt', help='model.pt path(s)')
